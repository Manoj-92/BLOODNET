...
function HospitalLogin(){
    ...
    const handleSumbit = async (e:React.FormEvent)=>{
        ...
        try{
          const response = await axios.post("http://localhost:5000/login/hospital",{
             hospitalId,
             password
          },{
          ...
          alert("Error in Hospital Login ! Please enter valid Credentials")
        }
    }
    ...
    return(
        <div className="relative w-screen h-screen bg-black text-white flex justify-center items-center p-10">
            ...
            <div className="absolute top-20">
                <h1 className="text-[40px] font-medium font-mono bg-gradient-to-r from-red-800 to-red-500 bg-clip-text text-transparent">Hospital Login</h1>
            </div>
            ...
            <div className="absolute w-[63vmin] h-auto border-2 border-gray-600 rounded-2xl flex justify-center item-center flex-col p-5 font-mono gap-3 shadow-lg shadow-gray-400">
              <FaHospital className="text-[80px] text-center w-[100%] text-red-600"/>
